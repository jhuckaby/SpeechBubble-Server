// SpeechBubble Auto Installer
// Copyright (c) 2017 Joseph Huckaby, MIT License.
// https://github.com/jhuckaby/SpeechBubble-Server

// To install, issue this command as root:
// curl -s "https://raw.githubusercontent.com/jhuckaby/SpeechBubble-Server/master/bin/install.js" | node
...
var base_dir = '/opt/speechbubble';
var log_dir = base_dir + '/logs';
var log_file = '';
var gh_repo_url = 'http://github.com/jhuckaby/SpeechBubble-Server';
var gh_releases_url = 'https://api.github.com/repos/jhuckaby/SpeechBubble-Server/releases';
var gh_head_tarball_url = 'https://github.com/jhuckaby/SpeechBubble-Server/archive/master.tar.gz';
...
if (process.getuid() != 0) {
	die( "The SpeechBubble auto-installer must be run as root." );
}
...
print( 
	"\nSpeechBubble Installer v" + installer_version + "\n" + 
	"Copyright (c) 2017 PixlCore.com. MIT License.\n" + 
	"Log File: " + log_file + "\n\n" 
);
...
cp.exec('curl -s ' + gh_releases_url, function (err, stdout, stderr) {
	...
	if (is_preinstalled) print("Upgrading SpeechBubble from v"+cur_version+" to v"+new_version+"...\n");
	else print("Installing SpeechBubble v"+new_version+"...\n");
